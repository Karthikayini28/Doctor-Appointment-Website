...
const appoinmentsDoctor=async(req,res)=>{
  try{
    ...
    console.log('appdata',appointments)
...
export { changeAvailablity, doctorList,loginDoctor,appoinmentsDoctor,appoinmentCancel,appoinmentComplete,doctorDashboard ,updateDoctorProfile,doctorProfile}